...
player_img = image.load("Images/Ct_patch.png")
enemy_img = image.load("Images/T_patch.png")
...
class Ball:
    ...
    def draw_center(self, scale):
        ...
        if self.img:
            ...
            window.blit(self.img, (WINDOW_SIZE[0] // 2 - size, WINDOW_SIZE[1] // 2 - size))
...
while running:
    ...
    window.fill((0, 0, 0))
    window.blit(transform.scale(bg_img, WINDOW_SIZE), (0, 0))
